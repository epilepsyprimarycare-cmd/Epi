...
function updateStreamlinedCDSDisplay(analysis) {
    ...
    // Check for subtherapeutic dosing from warnings or doseFindings
    ...
    if (needsSpecialistReferral) {
        ...
        // Priority: subtherapeutic dosing needs dose optimization with specific targets
        planTone = 'warning';
...
function extractCounselingIcons(analysis, context = {}) {
    ...
    const iconRules = [
        ...
        { match: () => alertText.includes('teratogen') || alertText.includes('pregnancy') || alertText.includes('pregnant'), icon: 'fa-baby', label: 'Pregnancy risk', severity: 'danger', tooltip: 'Discuss teratogenic risks' },
