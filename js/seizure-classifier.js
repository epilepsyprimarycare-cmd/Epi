...
console.log('[SEIZURE-CLASSIFIER] seizure-classifier.js file loaded');
...
const ILAE_CLASSIFICATION_QUESTIONS = [
    {
        ...
        type: 'single',
        options: [
            { value: 'bilateral_tonic_clonic', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.seizureType.bilateralTonicClonic') : 'Stiffening then jerking - both sides of body', next: 'duration' },
    ...
    },
    {
        ...
        type: 'single',
        options: [
            { value: 'under_1min', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.duration.under1min') : 'Less than 1 minute', next: 'event_stereotypy' },
            { value: '1_to_2min', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.duration.1to2min') : '1-2 minutes', next: 'event_stereotypy' },
            { value: '2_to_5min', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.duration.2to5min') : '2-5 minutes', next: 'event_stereotypy' },
            { value: 'over_5min', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.duration.over5min') : 'More than 5 minutes', next: 'event_stereotypy' }
        ]
    },
    {
        id: 'event_stereotypy',
        ...
        showIf: [
            ...
            { id: 'pnes_check', anyOf: ['hypermotor', 'gradual', 'side_to_side', 'long_duration'] },
        ...
        type: 'single',
        options: [
            { value: 'yes', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.eventStereotypy.yes') : 'Yes, highly stereotyped', next: 'movement_duration' },
            { value: 'no', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.eventStereotypy.no') : 'No, variable each time', next: 'movement_duration' },
            { value: 'unknown', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.eventStereotypy.unknown') : 'Not sure / don\'t know', next: 'movement_duration' }
        ]
    },
    {
        ...
        skipTo: 'post_ictal',
        question: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.movementDuration.question') : 'How long do the movements last each time (web ask for each event)?',
        type: 'single',
        options: [
            { value: 'under_30s', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.movementDuration.under30s') : 'Under 30 seconds', next: 'post_ictal' },
            { value: '30_to_60s', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.movementDuration.30to60s') : '30-60 seconds', next: 'post_ictal' },
            { value: '1_to_2min', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.movementDuration.1to2min') : '1-2 minutes', next: 'post_ictal' },
            { value: '2_to_5min', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.movementDuration.2to5min') : '2-5 minutes', next: 'post_ictal' },
            { value: 'over_5min', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.movementDuration.over5min') : 'More than 5 minutes', next: 'post_ictal' }
        ]
    },
    {
        id: 'post_ictal',
        ...
        type: 'single',
        options: [
            { value: 'yes_prolonged', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.postIctal.yesProlonged') : 'Yes, confused/sleepy for 10+ minutes', next: 'tongue_bite' },
            { value: 'yes_brief', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.postIctal.yesBrief') : 'Yes, but recovered in 5-10 minutes', next: 'tongue_bite' },
            { value: 'no', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.postIctal.no') : 'No, alert immediately after', next: 'pnes_check' }
        ]
    },
    {
        id: 'tongue_bite',
        ...
        type: 'single',
        options: [
            { value: 'yes', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.tongueBite.yes') : 'Yes', next: 'triggers' },
            { value: 'no', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.tongueBite.no') : 'No', next: 'triggers' },
            { value: 'unknown', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.tongueBite.unknown') : 'Not sure', next: 'triggers' }
        ]
    },
    {
        id: 'pnes_check',
        question: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.pnesCheck.question') : 'During the event (select all that apply):',
        type: 'multiple',
        options: [
            { value: 'eyes_closed', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.pnesCheck.eyesClosed') : 'Eyes were closed' },
            { value: 'gradual', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.pnesCheck.gradual') : 'Movements built up gradually' },
            { value: 'side_to_side', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.pnesCheck.sideToSide') : 'Side-to-side thrashing' },
            { value: 'hypermotor', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.pnesCheck.hypermotor') : 'Vigorous hypermotor / dystonic movements' },
            { value: 'none', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.pnesCheck.none') : 'None of these' }
        ],
        next: 'triggers'
    },
    {
    ...
    },
    {
        ...
        next: 'post_event_recovery'
    },
    {
        id: 'post_event_recovery',
        question: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.postEventRecovery.question') : 'After the event ended:',
        type: 'single',
        options: [
            { value: 'immediate', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.postEventRecovery.immediate') : 'Immediately alert and oriented', next: 'frequency' },
            { value: 'confused', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.postEventRecovery.confused') : 'Confused for several minutes', next: 'frequency' },
            { value: 'distressed', label: () => window.EpicareI18n ? window.EpicareI18n.translate('seizureClassifier.postEventRecovery.distressed') : 'Emotionally distressed but mentally clear', next: 'frequency' }
        ]
    },
    {
        id: 'fall_awareness',
...
class SeizureClassificationTool {
    ...
    initialize(patientId, ageAtOnsetYears = null) {
        console.log('[SEIZURE-CLASSIFIER] initialize() called with patientId:', patientId);
        this.mode = 'record';
        this.patientId = patientId;
        this.ageAtOnsetYears = typeof ageAtOnsetYears === 'number' ? ageAtOnsetYears : this.ageAtOnsetYears;
        this.responses = {};
        this.questionHistory = [];
        console.log('[SEIZURE-CLASSIFIER] Rendering first visible question');
        this.renderQuestion(this.getFirstVisibleQuestion());
        console.log('[SEIZURE-CLASSIFIER] initialize() complete');
    }

    initializeForForm(targetFieldId, ageAtOnsetYears = null) {
        console.log('[SEIZURE-CLASSIFIER] initializeForForm() called with targetFieldId:', targetFieldId);
        this.mode = 'form';
        this.targetFieldId = targetFieldId;
        this.ageAtOnsetYears = typeof ageAtOnsetYears === 'number' ? ageAtOnsetYears : this.ageAtOnsetYears;
        this.responses = {};
        this.questionHistory = [];
        console.log('[SEIZURE-CLASSIFIER] Rendering first visible question to container');
        this.renderQuestion(this.getFirstVisibleQuestion());
        console.log('[SEIZURE-CLASSIFIER] initializeForForm() complete');
    }
    
    renderQuestion(question) {
        let container = document.getElementById('seizureClassifierContainer');
        try {
            console.log('[SEIZURE-CLASSIFIER] renderQuestion() called with question:', question && question.id);
            console.log('[SEIZURE-CLASSIFIER] Questions loaded:', Array.isArray(ILAE_CLASSIFICATION_QUESTIONS) ? ILAE_CLASSIFICATION_QUESTIONS.length : 'NO QUESTIONS');
            if (!Array.isArray(ILAE_CLASSIFICATION_QUESTIONS) || ILAE_CLASSIFICATION_QUESTIONS.length === 0) {
                console.error('[SEIZURE-CLASSIFIER] No ILAE questions defined - abort render');
            }
        } catch (err) {
            console.error('[SEIZURE-CLASSIFIER] renderQuestion log failed', err);
        }
        try {
            ...
            if (!question || !question.id) {
                ...
                console.warn('[SEIZURE-CLASSIFIER] renderQuestion: No question passed or invalid, falling back to first visible question');
        ...
        if (!container) {
            console.error('[SEIZURE-CLASSIFIER] Container element not found with id="seizureClassifierContainer"');
            window.Logger.warn('seizure-classifier.js: Container not found');
            return;
        }
        console.log('[SEIZURE-CLASSIFIER] Container element found, rendering question:', question.question);
        ...
        if (question.showIf) {
            if (!this.evaluateShowIf(question)) {
                console.log('[SEIZURE-CLASSIFIER] renderQuestion: Skipping question due to showIf rules:', question.id);
        ...
        console.log('[SEIZURE-CLASSIFIER] renderQuestion() complete - HTML rendered to container');
        } catch (err) {
            console.error('[SEIZURE-CLASSIFIER] Error in renderQuestion', err);
            try {
                if (container) {
                    ...
                    console.warn('[SEIZURE-CLASSIFIER] renderQuestion: No container to display fallback UI. Error details:', err && err.message);
                ...
                console.error('[SEIZURE-CLASSIFIER] Failed to show fallback UI', e);
            }
        }
    }
    ...
    computeSimpleOnsetSummary() {
        ...
        const pnesCheck = Array.isArray(r.pnes_check) ? r.pnes_check : (r.pnes_check ? [r.pnes_check] : []);
        ...
        if (typeof r.durationSeconds === 'number') durationSec = r.durationSeconds;
            ...
            const map = { 'under_1min': 30, '1_to_2min': 90, '2_to_5min': 180, 'over_5min': 300 };
            durationSec = map[r.duration] || null;
        }

        // Movement duration (explicit question "How long do the movements last each time?")
        let movementDurationSec = null;
        if (typeof r.movementDurationSeconds === 'number') movementDurationSec = r.movementDurationSeconds;
        else if (r.movement_duration && typeof r.movement_duration === 'string') {
            const mdmap = { 'under_30s': 25, '30_to_60s': 45, '1_to_2min': 90, '2_to_5min': 180, 'over_5min': 300 };
            movementDurationSec = mdmap[r.movement_duration] || null;
        }

        // --- PNES gate (Module A) ---
        const eyesClosedPNES = pnesFeatures.includes('eyes_closed') || pnesCheck.includes('eyes_closed');
        if (eyesClosedPNES) { pnesScore += 2; contributors.push({ feature: 'eyes_closed', target: 'pnes', contrib: 2 }); }

        if (durationSec !== null && durationSec >= 120) { pnesScore += 2; contributors.push({ feature: 'duration', target: 'pnes', contrib: 2 }); }

        const chaoticMovementPNES = pnesFeatures.includes('side_to_side') || pnesCheck.includes('side_to_side') || pnesFeatures.includes('gradual') || pnesCheck.includes('gradual');
        if (chaoticMovementPNES) { pnesScore += 1; contributors.push({ feature: 'chaotic_movement', target: 'pnes', contrib: 1 }); }

        if (r.seizure_type === 'possible_dissociative') { pnesScore += 1; contributors.push({ feature: 'possible_dissociative', target: 'pnes', contrib: 1 }); }
        if (pnesFeatures.includes('long_duration')) { pnesScore += 1; contributors.push({ feature: 'long_duration', target: 'pnes', contrib: 1 }); }

        const isHighPNES = pnesScore >= 3;

        // --- Focal vs Generalized (Module B) ---
        if (r.aura_present === 'yes') { focalScore += 2; contributors.push({ feature: 'aura_present', target: 'focal', contrib: 2 }); }
        ...
        if (r.seizure_type === 'myoclonic' && r.jerk_timing === 'morning') { generalizedScore += 3; contributors.push({ feature: 'morning_myoclonus', target: 'generalized', contrib: 3 }); }
        ...
        const todd = (r.toddParesis || r.post_ictal_weakness === 'unilateral' || r.post_ictal_weakness === 'Unilateral');
        if (todd) { focalScore += 2; contributors.push({ feature: 'todd_paresis', target: 'focal', contrib: 2 }); }
        ...
        const hypermotorPresent = pnesFeatures.includes('hypermotor') || pnesCheck.includes('hypermotor');
        if (hypermotorPresent) { focalScore += 1; contributors.push({ feature: 'hypermotor', target: 'focal', contrib: 1 }); }

        // New: brief movement support (if movementDurationSec exists and is brief)
        const briefMovement = (movementDurationSec !== null) ? (movementDurationSec < 60) : (durationSec !== null ? durationSec < 60 : false);
        ...
        // --- Special handling for prolonged GTCS with no injury/tongue bite ---
        ...
        if ((pnesFeatures.includes('eyes_closed') || chaoticMovementPNES || pnesFeatures.includes('long_duration') || pnesCheck.includes('long_duration'))
        ...
        return { pnesScore, focalScore, generalizedScore, isHighPNES, summaryOnset, probObj, confidence: maxProb, explanation, unusualPattern, possibleSHEvsPNES };
    }
    ...
    getFirstVisibleQuestion() {
        ...
        for (const q of ILAE_CLASSIFICATION_QUESTIONS) {
            try {
                ...
                console.warn('[SEIZURE-CLASSIFIER] getFirstVisibleQuestion: evaluateShowIf failed, defaulting to show question', q && q.id, e);
                return q;
            }
        }
            ...
            <div class="classification-result" style="text-align: center;">
                ...
                <div class="classification-card" style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px; text-align: left;">
                    ...
                    <div style="margin-bottom:8px; display:flex; align-items:center; justify-content:space-between;">
                        ...
                        <div style="font-weight:600; color:${confColor};">${confPerc}% (${simple.summaryOnset})</div>
                    </div>
                    ...
                    <div style="font-size:0.9rem; color:#666; margin-bottom:6px;">
                        Focal: ${Math.round((simple.probObj.focalProb || 0) * 100)}% | 
    ...
    calculateProgress() {
        return Math.round((this.questionHistory.length / ILAE_CLASSIFICATION_QUESTIONS.length) * 100);
    }
    ...
    calculateClassification() {
        ...
        if (responses.seizure_type === 'possible_dissociative') {
            ...
            if (pnesCount >= 2) {
                ...
                if (responses.post_event_recovery === 'immediate') {
        ...
        if (responses.seizure_type === 'bilateral_tonic_clonic' && responses.post_ictal === 'no') {
            const pnesCheck = responses.pnes_check || [];
            const pnesArray = Array.isArray(pnesCheck) ? pnesCheck : [pnesCheck];
            const pnesCount = pnesArray.filter(f => f !== 'none' && f).length;
        ...
        try {
            if (isBorderline) {
                classification.recommendations.unshift(
                    '⚠️ Red Flag: Reported prolonged bilateral convulsion with NO injury/tongue-bite is unusual — consider PNES and refer for or specialist review.'
                );
            }
...
function initializeSeizureClassifier(patientId, ageAtOnsetYears = null) {
    console.log('[SEIZURE-CLASSIFIER] initializeSeizureClassifier() called with patientId:', patientId);
    if (!seizureClassifier) {
        console.log('[SEIZURE-CLASSIFIER] Creating new SeizureClassificationTool instance');
        seizureClassifier = new SeizureClassificationTool();
    }
    console.log('[SEIZURE-CLASSIFIER] Calling seizureClassifier.initialize()');
    ...
    console.log('[SEIZURE-CLASSIFIER] initializeSeizureClassifier() complete');
}

function initializeSeizureClassifierForForm(targetFieldId, ageAtOnsetYears = null) {
    console.log('[SEIZURE-CLASSIFIER] initializeSeizureClassifierForForm() called with targetFieldId:', targetFieldId);
    if (!seizureClassifier) {
        console.log('[SEIZURE-CLASSIFIER] Creating new SeizureClassificationTool instance');
        seizureClassifier = new SeizureClassificationTool();
    }
    console.log('[SEIZURE-CLASSIFIER] Calling seizureClassifier.initializeForForm()');
    ...
    console.log('[SEIZURE-CLASSIFIER] initializeSeizureClassifierForForm() complete');
}